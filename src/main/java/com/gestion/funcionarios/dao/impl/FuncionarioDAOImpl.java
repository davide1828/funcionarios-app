...
public class FuncionarioDAOImpl implements FuncionarioDAO {
    ...
    private static final String BASE_SELECT =
        "SELECT f.id, f.nombres, f.apellidos, f.numero_documento, " +
    ...
    private static final String SQL_FIND_ALL =
        BASE_SELECT + "ORDER BY f.apellidos, f.nombres";
    ...
    /**
     * Construye un objeto {@link Funcionario} completo desde una fila del ResultSet.
